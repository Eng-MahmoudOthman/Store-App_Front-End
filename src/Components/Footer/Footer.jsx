            ...
            <div className="container" dir="rtl">
               <div className="row justify-content-between">
                  ...
                  <div className="col-md-5 col-lg-3 mt-4">
                     ...
                     <ul>
                        <li><a className="footer_link" target="_blank"  href="www.facebook.com"><i class="icon fa-brands fa-facebook-f"></i> Facebook</a></li>
                        <li><a className="footer_link" target="_blank"  href="www.instagram.com"><i class="icon ms-3 fa-brands fa-instagram"></i> Instagram</a></li>
                        <li><a className="footer_link" href="sms:+201126999142"><i class=" icon fa-regular fa-envelope"></i> Send SMS  </a></li>
                     </ul>
                  </div>
                  ...
                  <div className="col-md-5 col-lg-2 mt-4 ms-3">
                     ...
                     <ul>
                        <li><a className="footer_link"  href="mailto:mahmoud.osman440@gmail.com"> <i class=" icon fa-regular fa-envelope"></i> info@gmail.com</a></li>
                        <li><a className="footer_link"  href="https://wa.me/+201126999142"><i class=" icon fa-brands fa-whatsapp"></i> 01126999142</a></li>
                        <li><a className="footer_link"  href="tel:201022496810"><i class="icon fa-solid fa-phone-volume"></i> 01126999142</a></li>
                        <li><a  href="/" className="footer_link"><i class="icon fa-solid fa-location-dot"></i> Cairo, Egypt</a></li>
                     </ul>
                  </div>
               </div>
