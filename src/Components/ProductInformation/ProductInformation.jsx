      ...
      <Fragment>
         <div className="row my-5 product_information">
            ...
            <div className="col-md-6">
               ...
               <div className='row justify-content-center align-items-center mt-4 g-2'>
                  ...
                  <div className="col-9">
                     <div className='text-start'>
                        <button onClick={()=>{addToCart(id)}} className='btn btn-cart main-btn btn-discovery w-100'>إضافة إلى السلة</button>
                     </div>
                  </div>
               </div>
               ...
               <div className='mt-3 '>
                  <button  onClick={()=>{addToWishList(id)}} className='border-0 bg-white button_add_favorite'>
                     {addWishList ? <i class="fa-solid fa-heart"></i> : <i class="fa-regular fa-heart"></i>}  إضافة للمفضلة
                  </button>
               </div>
            </div>
         </div>
